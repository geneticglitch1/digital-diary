...
export default function CreateGuidedEntry() {
  ...
  const handleConfirmFollowup = async (wantsFollowup: boolean) => {
    if (wantsFollowup) {
      ...
      // Skip follow-up questions and save directly
      await handleFinalSubmit()
    }
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (currentStep === 'prompts') {
      // Show confirmation prompt for follow-up questions
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              {/* Step 2.5: Confirm Follow-up Questions */}
                    ...
                    <div className="text-center">
                      ...
                      <div className="flex justify-center gap-4">
                        <button
                          ...
                          disabled={isLoading}
                          className="px-6 py-3 border-2 border-purple-300 rounded-lg text-sm font-medium text-purple-700 bg-white hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                        >
                          No, save entry
                        </button>
                        <button
